...
public class WalletController {
    ...
    @PutMapping(value = PathApi.MODEL_UPDATE_DOMAIN)
    ...
    @DeleteMapping(value = PathApi.MODEL_DELETE_DOMAIN)
    ...
    @GetMapping(value =  PathApi.MODEL_GET_LIST_DOMAIN)
    ...
    @GetMapping(value =  PathApi.MODEL_GET_ONE_DOMAIN)
